  ...
  return (
    ...
    >
      ...
      <p className="lead text-center">
        ...
        dynamic and efficient applications. Focused on full-stack development, I
      ...
      <p className="lead text-center">
        I am currently enrolled in the Washington University in St. Louis EdX
        programming bootcamp where I am enhancing my skills in full-stack web
      ...
      <p className="text" id="machine">
        I sourced parts and built my machine myself at home. Here's some specs:
        <ul>
